...
# from .Mednext.MedNextV1 import MedNeXt1 as MedNeXt#增加了输出层
from monai.transforms import AsDiscrete
from .corrector.reg import Reg3D,Transformer_3D
from .corrector.losses import * #SSIM3D
...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
        ...
        self.num_epochs = 400##1000  400x250=10 0000
        self.current_epoch = 0
        self.enable_deep_supervision = True #True False
        self.to_label = AsDiscrete(argmax=True, to_onehot=5)
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        #     n_classes=5,exp_r=[3, 4, 8, 8, 8, 8, 8, 4, 3],
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        # weight=np.array([1, 1, 2, 5])#### [1, 1, 2, 5] [1, 1, 3]
