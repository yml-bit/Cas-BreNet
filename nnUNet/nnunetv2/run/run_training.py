...
# from nnunetv2.training.nnUNetTrainer.nnUNetTrainer_p2_xc import nnUNetTrainer
...
def run_training_entry():
    ...
    #301 3d_fullres 0
    #batch_size=2; patch=96x160x160;default_num_processes=8 nnUNetv2_train 301 3d_fullres 0
