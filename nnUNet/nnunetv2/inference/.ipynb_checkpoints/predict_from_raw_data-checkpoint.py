...
if __name__ == '__main__':
    ...
    # inputs = "/media/wangtao/data/yml/data/external/catch"
    ...
    for line in f.readlines():
            ...
            out_put=path.replace("breast","breast_test")#lo:97  x1:54  xlo2:10
    ...
    #     allow_tqdm=True
    #     )
    # #/media/wangtao/yml_data2/data_use/p2_nii
    # predictor.initialize_from_trained_model_folder(
