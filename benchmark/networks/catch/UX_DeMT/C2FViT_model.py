...
class OverlapPatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=(96,96,64), patch_size=7, stride=4, in_chans=3, embed_dim=768, flatten=True):
        super().__init__()
...
class C2F_ViT_stage(nn.Module):
    def __init__(self, img_size=(96,96,64), patch_size=[3, 7, 15], stride=[2, 4, 8], num_classes=12, embed_dims=[256, 256, 256],
