...
class DeformConv3d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=(3,3,3), stride=1, padding=1, bias=False):#(3,3,1)
        ...
        self.conv_kernel = nn.Conv3d(in_channels, out_channels, kernel_size=(1,1,1), bias=bias)
...
def deform_conv3x3x3(in_planes, out_planes, stride=1):
    ...
    return DeformConv3d(in_planes, out_planes, kernel_size=(3,3,1), stride=stride, padding=1, bias=False)
