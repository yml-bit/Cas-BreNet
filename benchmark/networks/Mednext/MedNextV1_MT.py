...
class LesionClassifier(nn.Module):#0405
...
class LesionClassifier1(nn.Module):#0406
...
class MedNeXt_MT(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.outside_block_checkpointing:
            ...
            class_output = self.classification_head(dec_x)
        ...
        return x, class_output.squeeze(dim=-1)
